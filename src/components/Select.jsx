    ...
    return (
        <>
            ...
            {isSelected && <ul className={Styles.options}>
                <li onClick={handleOptionSelect} data-value="dedfefd1">dedfefd1</li>
                <li onClick={handleOptionSelect} data-value="dedfefd2">dedfefd2</li>
                <li onClick={handleOptionSelect} data-value="dedfefd3">dedfefd3</li>
                <li onClick={handleOptionSelect} data-value="dedfefd4">dedfefd4</li>
                <li onClick={handleOptionSelect} data-value="dedfefd5">dedfefd5</li>
            </ul>}
        </>
    )
}
